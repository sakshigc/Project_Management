...
session_start();
$r2=$_SESSION['r2'];
$sql = "SELECT * FROM week WHERE rolla='$r2'";
  if($res = mysqli_query($conn, $sql))
  {
   ...
   {
       if(mysqli_query($conn,"select * from guide where rolln1='$r2'"))
       {
         if(($_POST["status"]!=""))
         {
           $sql1="INSERT INTO guideact (rolla, week, status) VALUES ('$r2','$f1','$_POST[status]')";
           ...
           {
             $sql2="INSERT INTO marks (rollm, actname, marks,follow,deadline) VALUES ('$r2','$_POST[actname]','$_POST[marks]','$_POST[follow]','$_POST[deadline]')";
...
<body>
  <div class="topnav">
    ...
    <a href="g1.php">Group 1</a>
      <a class="active"  href="grp2.php">Group 2</a>
...
<form method="post" action="" name="Regform">
 ...
 <div class="go"><button type="submit" name="go">go</button></div> <br><br>
  ...
  if(isset($_POST["go"]))
  {
    if(mysqli_query($conn,"select * from guide where rolln1='$r2'"))
    {
          $sql4="INSERT INTO week (rolla,week) VALUES ('$r2','$_POST[week]')";
...
error_reporting(0);
echo "<tbody>";
$sql = "SELECT * FROM marks WHERE rollm='$r2'";
if($res = mysqli_query($conn, $sql))
{
    if(mysqli_num_rows($res) > 0)
    {
...
<hr >
<form name="Regform" action="grp2.php" method="post" autocomplete="off" >
   <!-- <div class ="border"> -->
